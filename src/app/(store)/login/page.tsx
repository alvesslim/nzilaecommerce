...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 pt-[72px]">
      <div className="w-full max-w-[450px] bg-surface border border-border rounded-3xl p-10 relative overflow-hidden max-sm:p-8">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5 relative z-10">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex justify-between items-center">
              ...
              <Link href="#" className="text-[0.8rem] text-blue-light no-underline hover:underline">
                Esqueceu-se?
              </Link>
            </div>
            <div className="relative">
        ...
        <div className="mt-8 text-center text-[0.95rem] text-text2 relative z-10">
          Não tem uma conta?{' '}
          <Link href={ROUTES.REGISTER} className="text-blue-light font-bold no-underline hover:underline">
            Registar-se
          </Link>
        </div>
      </div>
